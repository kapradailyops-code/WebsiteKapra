  ...
  return (
    ...
    >
      <div className="relative h-[42rem] w-[96rem] max-w-none -translate-y-12 scale-y-[1.2] sm:h-[52rem]">
        <motion.div
          animate={{ opacity: [0.18, 0.28, 0.18], scaleX: [0.9, 1.08, 0.9] }}
          transition={{ duration: 16, repeat: Infinity, ease: "easeInOut" }}
          style={{
            backgroundImage:
              "conic-gradient(from 70deg at center top, rgba(34,211,238,0.5), transparent 20%, transparent 72%)"
          }}
          className="absolute right-1/2 top-0 h-64 w-[24rem] origin-right sm:h-72 sm:w-[38rem]"
        >
        ...
        <motion.div
          animate={{ opacity: [0.18, 0.28, 0.18], scaleX: [0.9, 1.08, 0.9] }}
          transition={{ duration: 16, repeat: Infinity, ease: "easeInOut", delay: 0.25 }}
          style={{
            backgroundImage:
              "conic-gradient(from 290deg at center top, transparent, transparent, rgba(34,211,238,0.5))"
          }}
          className="absolute left-1/2 top-0 h-64 w-[24rem] origin-left sm:h-72 sm:w-[38rem]"
        >
        ...
        <motion.div
          animate={{ opacity: [0.35, 0.58, 0.35], width: ["7rem", "13rem", "7rem"] }}
          transition={{ duration: 12, repeat: Infinity, ease: "easeInOut" }}
          className="absolute left-1/2 top-10 z-10 h-24 -translate-x-1/2 rounded-full bg-cyan-300/35 blur-2xl sm:top-12 sm:h-32"
        />

        <motion.div
          animate={{ opacity: [0.45, 0.8, 0.45], width: ["12rem", "20rem", "12rem"] }}
          transition={{ duration: 12, repeat: Infinity, ease: "easeInOut" }}
          className="absolute left-1/2 top-6 z-30 h-px -translate-x-1/2 bg-cyan-300/70 sm:top-10"
        />
